...
if ~exist('experimentid', 'var')
    ...
    if ~isempty(filename2),
        ...
        if ~strcmp(experimentid1,experimentid2),
            error('the two filenames provided have the same subjectid BUT different experimentid');
        else
...
%-------------------------------------------------------
Neravgcontrs=length(curPipecntrList{1});
%=======================================================================
%=======================================================================
%=======================================================================
...
[outStatus] = hcp_eravg_contrasts(cfg);

hcp_check_pipelineoutput('eravg', 'subject', subjectid, 'experiment', experimentid, 'scan', scanmnem,'avgmode',{'mag','planar'},'contrasts',procCntrNames);
