...
%# figure size printed on paper
    ...
    text(2,0.59,str{2},'Units','normalized','FontSize',22,'color',strcolor(2))
    text(1.2,0.53,leg{3},'Units','normalized','FontSize',22,'color',strcolor(3))
    text(2,0.53,str{3},'Units','normalized','FontSize',22,'color',strcolor(3))
    text(1.2,0.465,leg{4},'Units','normalized','FontSize',22,'color',strcolor(4))
    text(2,0.465,str{4},'Units','normalized','FontSize',22,'color',strcolor(4))
    text(1.2,0.40,leg{5},'Units','normalized','FontSize',22,'color',strcolor(5))
    text(2,0.40,str{5},'Units','normalized','FontSize',22,'color',strcolor(5))
    ...
    imgname=[subject '_icaclass_' num2str(ix)];
    disp('SAVING');
