function hcp_plot_montage(dat, varargin)
...
%
% $Id: hcp_plot_montage.m 9714 2014-07-09 15:09:36Z roboos $
...
for k = 1:nslice
  ...
  ix     = mod(k-1, div(1));
  iy     = floor((k-1)/div(1));
  h(k)   = hcp_plot_slice(dat, optarg{:}); % FIXME is it safe to pass all optinoal inputs?
