function[contrastList]=contrast_StoryM(trialinfo)

% This function produces a default list of contrasts for the Story Math
...
contrastList=contrast_StoryM_Basic(trialinfo);
